...
public class DataDrivenTesting extends Base {
	...
	public void DataDrivenTestingExample() throws Exception {
		...
		// File src=new File("D:\\Sample
		// Project\\SeleniumBatch2\\DataDrivenLoginEx.xlsx");
		...
		/*
		 * Working with Notepad: Writing data to Notepad String FilePath =
		 * "D:\\BookingID\\BookingID.txt"; FileWriter fr=new FileWriter(FilePath);
		 * BufferedWriter br=new BufferedWriter(fr); br.write(bookID); br.close();
		 */
		/*
		 * Read Data from Excel Sheet: String FilePath = "D:\\BookingID\\BookingID.txt";
		 * FileReader fr1=new FileReader(FilePath); BufferedReader br1= new
		 * BufferedReader(fr1); String BookingID = br1.readLine(); br1.close();
		 */
